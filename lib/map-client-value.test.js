...
/**
 * @typedef {import('./map-client-value').MappedFunction} MappedFunction
 * @typedef {import('./map-client-value').MappedProperties} MappedProperties
 */
...
describe('lib/parse-client-value', () => {
  ...
  it('handles Symbol', () => {
    const value = /** @type {symbol} */ (mapClientValue(['Symbol']));
  ...
  it('handles Symbol with description', () => {
    const value = /** @type {symbol} */ (mapClientValue(['Symbol', 'test']));
  ...
  it('handles anonymous function', () => {
    const value = /** @type {MappedFunction} */ (
      mapClientValue(['Function', '', [], []])
    );
  ...
  it('handles async function', () => {
    const value = /** @type {MappedFunction} */ (
      mapClientValue(['AsyncFunction', 'test', [], []])
    );
  ...
  it('handles generator function', () => {
    const value = /** @type {MappedFunction} */ (
      mapClientValue(['GeneratorFunction', 'test', [], []])
    );
  ...
  it('handles async generator function', () => {
    const value = /** @type {MappedFunction} */ (
      mapClientValue(['AsyncGeneratorFunction', 'test', [], []])
    );
  ...
  it('handles function with additional properties', () => {
    const value = /** @type {MappedFunction} */ (
      mapClientValue(['Function', '', [['test', ['Number', 42]]], []])
    );
  ...
  it('handles anonymous class', () => {
    const value = /** @type {new () => Object} */ (
      mapClientValue(['Class', ''])
    );
  ...
  it('handles named class with extends', () => {
    const value = /** @type {new () => Object} */ (
      mapClientValue(['Class', 'Test', 'Base'])
    );
  ...
  it('handles Date', () => {
    const value = /** @type {Date} */ (mapClientValue(['Date', 1718450169360]));
  ...
  it('handles invalid Date', () => {
    const value = /** @type {Date} */ (mapClientValue(['Date', 'NaN']));
  ...
  it('handles Object with symbol keys', () => {
    const object = /** @type {MappedProperties} */ (
      mapClientValue(['Object', [], [['test', ['Number', 42]]]])
    );
  ...
  it('handles Array with additional properties', () => {
    const array = /** @type {unknown[] & MappedProperties} */ (
      mapClientValue([
        'Array',
        [
          ['0', ['String', '7']],
  ...
  it('handles empty Set', () => {
    const value = /** @type {Set<unknown>} */ (mapClientValue(['Set', []]));
  ...
  it('handles empty Map', () => {
    const value = /** @type {Map<unknown, unknown>} */ (
      mapClientValue(['Map', []])
    );
